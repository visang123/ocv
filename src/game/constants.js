...
/** 첫 캐릭터 스폰 — 포탈 가로 중앙, 발 = 포탈 하단 */
export const SPAWN_PLAYER_X =
  SPAWN_PORTAL_X + SPAWN_PORTAL_WIDTH / 2 - PLAYER_WIDTH / 2;
export const SPAWN_PLAYER_DEPTH =
  GROUND_WORLD_HEIGHT - (SPAWN_PORTAL_Y + SPAWN_PORTAL_HEIGHT);
